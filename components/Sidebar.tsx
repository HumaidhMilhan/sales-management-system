...
import { LayoutDashboard, Package, Users, ScrollText, BarChart3, Settings, Store } from 'lucide-react';
...
const Sidebar: React.FC<SidebarProps> = ({ isOpen, onClose }) => {
  ...
  const navItems = [
    ...
    { icon: ScrollText, label: 'Sales', path: '/admin/reports' }, // Reuse reports for Sales
