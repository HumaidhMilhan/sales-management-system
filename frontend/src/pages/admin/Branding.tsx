          ...
          <div className="bg-white rounded-xl p-4 shadow-sm border border-slate-100">
            ...
            <div className="flex items-center gap-4">
              <div className="relative size-20 shrink-0 overflow-hidden rounded-full border-2 border-dashed border-slate-300 bg-slate-50 flex items-center justify-center group cursor-pointer hover:border-primary transition-colors">
                <img src="https://lh3.googleusercontent.com/aida-public/AB6AXuA2_sRp-UvZAQwPef3XXizqZwXQmpKzKikeUyuwtOXVz-Z8zX5kDnAQpICjq4n5zQ9QlOiwf4x6xfOFLOPHYiyy7YHpEI-pwr2b7zFb9sYJeTOMQ_ID_xgCAcAZ1bnJYca8OHKq3G-ilOZQKUSikIlrHW6N6RNQqnnA6_OPTV1v7FXzH_PxPGEU7bRkf7tIBqhwovWYfGpc4_Vxsuc6VKTqlKrsX_OTbcGENgUW6vGcOOF0Z7_XcK-qEw9Z3Ak3DoOiuTrMtnQ2JxnS" className="h-full w-full object-cover opacity-80 group-hover:opacity-40 transition-opacity" alt="Logo" />
